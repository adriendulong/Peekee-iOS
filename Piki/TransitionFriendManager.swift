//
//  TransitionFriendManager.swift
//  Piki
//
//  Created by Adrien Dulong on 15/12/2014.
//  Copyright (c) 2014 PikiChat. All rights reserved.
//

import UIKit

class TransitionFriendManager: UIPercentDrivenInteractiveTransition, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate, UIViewControllerInteractiveTransitioning  {
    ...
    var sourceViewController: SearchFriendsViewController!
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        let pikiController = self.presenting ? screens.to as SearchFriendsViewController : screens.from as SearchFriendsViewController
